...
class Application2(Frame):
    ...
    def botoes(self):
        ...
        tip_ajuda = tooltip.Hovertip(self.ajuda, 'Ajuda')
        ...
        tip_botao100 = tooltip.Hovertip(self.botao100, 'Grava de forma permanente a grelha de coordenadas UTM / Só funciona em modo admin\nN - Hemisfério Norte; qualquer outra letra - Hemisfério Sul')
        ...
        tip_botao02 = tooltip.Hovertip(self.botao02, 'Converte uma listagem de pontos com coordenadas UTM para um ficheiro kml')
        ...
        tip_botao18 = tooltip.Hovertip(self.botao18, 'Converte uma listagem de coordenadas WGS84 em coordenadas Datum (txt)')
...
class Application3(Frame):
    ...
    def botoes3(self):
        ...
        tip_botao_ajuda2 = tooltip.Hovertip(self.ajuda, 'Ajuda disponível na versão profissional...')
        ...
        tip_botao31 = tooltip.Hovertip(self.botao31, 'Converte uma listagem de elementos de rede em blocos autocad da PT (ficheiro .scr)')

        self.botao32 = Button(self, text='Edifícios_PT', command=blocos.edif_pt)
        self.botao32.grid(row=4, column=2, sticky=N+S+E+W)
        tip_botao32 = tooltip.Hovertip(self.botao32, 'Converte uma listagem de edifícios em blocos autocad da PT (ficheiro .scr)')
